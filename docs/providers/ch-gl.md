...
There are _11_ registered holidays for the **Glarus** provider in **2025**.

!!! info ""

    The below listed holidays (and the aforementioned number of holidays) merely reflect which holidays are registered
    with the Glarus provider in Yasumi. These do not indicate whether a particular holiday is
...
| :fontawesome-solid-leaf:{ .icon title="Regular holiday" } | 2025-04-03 | Thursday | nafelserFahrt | Other |
...
the holidays given by the **Glarus** Holiday provider.
