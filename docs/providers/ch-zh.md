...
There are _9_ registered holidays for the **Zürich** provider in **2024**.

!!! info ""

    The below listed holidays (and the aforementioned number of holidays) merely reflect which holidays are registered
    with the Zürich provider in Yasumi. These do not indicate whether a particular holiday is
...
the holidays given by the **Zürich** Holiday provider.
