...
There are _14_ registered holidays for the **Castile and León** provider in **2025**.

!!! info ""

    The below listed holidays (and the aforementioned number of holidays) merely reflect which holidays are registered
    with the Castile and León provider in Yasumi. These do not indicate whether a particular holiday is
...
| :fontawesome-solid-leaf:{ .icon title="Regular holiday" } | 2025-04-23 | Wednesday | castileAndLeonDay | Official |
