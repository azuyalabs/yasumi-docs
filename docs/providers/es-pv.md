...
There are _14_ registered holidays for the **Basque Country** provider in **2025**.

!!! info ""

    The below listed holidays (and the aforementioned number of holidays) merely reflect which holidays are registered
    with the Basque Country provider in Yasumi. These do not indicate whether a particular holiday is
...
the holidays given by the **Basque Country** Holiday provider.
