...
There are _12_ registered holidays for the **Appenzell Innerrhoden** provider in **2025**.

!!! info ""

    The below listed holidays (and the aforementioned number of holidays) merely reflect which holidays are registered
    with the Appenzell Innerrhoden provider in Yasumi. These do not indicate whether a particular holiday is
...
the holidays given by the **Appenzell Innerrhoden** Holiday provider.
