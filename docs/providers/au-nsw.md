...
There are _12_ registered holidays for the **New South Wales** provider in **2025**.

!!! info ""

    The below listed holidays (and the aforementioned number of holidays) merely reflect which holidays are registered
    with the New South Wales provider in Yasumi. These do not indicate whether a particular holiday is
...
| :fontawesome-solid-leaf:{ .icon title="Regular holiday" } | 2025-08-04 | Monday | Bank Holiday | Bank |
...
the holidays given by the **New South Wales** Holiday provider.
