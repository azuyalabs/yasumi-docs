...
There are _13_ registered holidays for the **Saxony** provider in **2026**.

!!! info ""

    The below listed holidays (and the aforementioned number of holidays) merely reflect which holidays are registered
    with the Saxony provider in Yasumi. These do not indicate whether a particular holiday is
...
| :fontawesome-solid-leaf:{ .icon title="Regular holiday" } | 2026-11-18 | Wednesday | repentanceAndPrayerDay | Official |
...
the holidays given by the **Saxony** Holiday provider.
