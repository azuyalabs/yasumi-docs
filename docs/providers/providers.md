...
The latest release of Yasumi supports 152 providers (44
...
#world-map-providers {
  ...
  svg {
    ...
    #AR, #AU, #AT, #BE, #BA, #BR, #BG, #CA, #HR, #CZ, #DK, #EE, #FI, #FR, #GE, #DE, #GR, #HU, #IR, #IE, #IT, #JP, #LV, #LT, #LU, #MX, #NL, #NZ, #NO, #PL, #PT, #RO, #RU, #SK, #SI, #ZA, #KR, #ES, #SE, #CH, #TR, #US, #UA, #GB {
        fill: #028090;
    }
  }
</style>
