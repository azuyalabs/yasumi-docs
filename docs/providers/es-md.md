...
There are _16_ registered holidays for the **Madrid Autonomous Community** provider in **2026**.

!!! info ""

    The below listed holidays (and the aforementioned number of holidays) merely reflect which holidays are registered
    with the Madrid Autonomous Community provider in Yasumi. These do not indicate whether a particular holiday is
...
| :fontawesome-solid-leaf:{ .icon title="Regular holiday" } | 2026-05-02 | Saturday | dosdeMayoUprisingDay | Official |
...
the holidays given by the **Madrid Autonomous Community** Holiday provider.
