...
There are _13_ registered holidays for the **Zug** provider in **2025**.

!!! info ""

    The below listed holidays (and the aforementioned number of holidays) merely reflect which holidays are registered
    with the Zug provider in Yasumi. These do not indicate whether a particular holiday is
...
the holidays given by the **Zug** Holiday provider.
