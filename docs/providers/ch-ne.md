...
There are _10_ registered holidays for the **Neuchâtel** provider in **2025**.

!!! info ""

    The below listed holidays (and the aforementioned number of holidays) merely reflect which holidays are registered
    with the Neuchâtel provider in Yasumi. These do not indicate whether a particular holiday is
...
| :fontawesome-solid-leaf:{ .icon title="Regular holiday" } | 2025-03-01 | Saturday | instaurationRepublique | Other |
...
the holidays given by the **Neuchâtel** Holiday provider.
