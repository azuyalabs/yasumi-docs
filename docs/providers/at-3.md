...
There are _16_ registered holidays for the **Lower Austria** provider in **2026**.

!!! info ""

    The below listed holidays (and the aforementioned number of holidays) merely reflect which holidays are registered
    with the Lower Austria provider in Yasumi. These do not indicate whether a particular holiday is
...
| :fontawesome-solid-leaf:{ .icon title="Regular holiday" } | 2026-11-15 | Sunday | Saint Leopold’s Day | Official |
...
the holidays given by the **Lower Austria** Holiday provider.
